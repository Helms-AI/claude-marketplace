...
When invoked with `/frontend-data-viz`, implement data visualizations using modern charting libraries with a focus on accessibility and performance.
...
|------------|------------------|
| `/user-experience-color-alchemist` | Chart color palette, sequential/diverging scales, categorical colors |
| `/user-experience-typography-curator` | Data typography, tabular figures, label sizing |

### Context This Skill Provides

| To Skill | Context Provided |
|----------|------------------|
| `/frontend-accessibility-auditor` | Chart accessibility audit, data table alternatives, color contrast in charts |
| `/frontend-performance-engineer` | Rendering optimization needs, canvas vs SVG recommendations, data point limits |
...
- **Sam Rivera (Systems):** Chart color tokens from design system
- **Casey Williams (A11y):** Accessible alternatives, color contrast
- **Jordan Park (Motion):** Chart animation and transitions
- **Taylor Brooks (Performance):** Bundle impact, lazy loading
