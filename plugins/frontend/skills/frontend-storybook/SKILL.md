...
When invoked with `/frontend-storybook`, set up and create Storybook documentation for component libraries using modern CSF3 format.
...
|------------|------------------|
| `/frontend-component-architect` | Component specs, prop interfaces |
| `/frontend-design-system` | Design tokens, theme configuration |

### Context This Skill Provides

| To Skill | Context Provided |
|----------|------------------|
| `/frontend-orchestrator` | Documentation deliverables, coverage status |

### Announcing Context Transfer

When passing context to another skill, announce:
```
"**Parker Lee → Chris Nakamura:** Documentation complete for [component/system]. Stories cover [variants/states]. Ready for [next phase]."
```
...
- **Alex Kim (Architecture):** Component structure and props design
- **Sam Rivera (Systems):** Design token integration
- **Casey Williams (A11y):** Accessibility testing requirements
- **Jordan Park (Motion):** Animation documentation
