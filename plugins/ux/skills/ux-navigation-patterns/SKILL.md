...
When invoked with `/ux-navigation-patterns`, design navigation systems that help users understand where they are, where they can go, and how to get there.
...
|------------|------------------|
| `/ux-aesthetic-director` | Visual tone, spacing rhythm |
| `/ux-orchestrator` | User's original request, site structure |
| `/ux-layout-composer` | Sidebar placement, responsive behavior |

### Context This Skill Provides

| To Skill | Context Provided |
|----------|------------------|
| `/ux-component-architect` | Nav component specifications |
| `/ux-accessibility-auditor` | Keyboard navigation, ARIA patterns |
| `/ux-responsive-engineer` | Mobile nav behavior |
| `/ux-motion-designer` | Nav animation opportunities |

### Announcing Context Transfer

When passing context to another skill, announce:
```
"**Sage → [Next Team Member]:** Here's the navigation structure:
