...
When invoked with `/ux-form-experience`, design forms that feel effortless to complete, with clear validation, helpful error recovery, and accessibility as a foundation.
...
|------------|------------------|
| `/ux-aesthetic-director` | Visual tone, input styling direction |
| `/ux-orchestrator` | User's original request, data requirements |
| `/ux-layout-composer` | Form layout patterns, spatial rhythm |

### Context This Skill Provides

| To Skill | Context Provided |
|----------|------------------|
| `/ux-component-architect` | Input components, validation patterns |
| `/ux-accessibility-auditor` | Form associations, error handling for review |
| `/ux-micro-delight` | Success state opportunities |

### Announcing Context Transfer

When passing context to another skill, announce:
```
"**Jesse → [Next Team Member]:** Here's the form specification:
