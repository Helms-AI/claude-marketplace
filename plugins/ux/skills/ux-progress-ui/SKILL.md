...
When invoked with `/ux-progress-ui`, design loading states and progress indicators that maintain user engagement and reduce perceived wait times.
...
|------------|------------------|
| `/ux-aesthetic-director` | Aesthetic brief, animation tone, brand personality |
| `/ux-orchestrator` | User's original request, component scope |
| `/ux-motion-designer` | Animation principles, easing curves |

### Context This Skill Provides

| To Skill | Context Provided |
|----------|------------------|
| `/ux-component-architect` | Loading component patterns, skeleton structures |
| `/ux-accessibility-auditor` | ARIA live regions, loading announcements |
| `/ux-performance-engineer` | Loading strategy, perceived performance notes |

### Announcing Context Transfer

When passing context to another skill, announce:
```
"**Kai → [Next Team Member]:** Here's the loading experience:
